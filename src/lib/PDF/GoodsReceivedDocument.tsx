...
const styles = StyleSheet.create({
    ...
    infoBox: { // Used for top order details box
        borderWidth: 1,
        borderColor: '#CCCCCC',
        borderRadius: 3,
        marginBottom: 10,
    ...
    // Combined Receiver Details, Confirmation & Signature Section
    receiverDetailsSection: {
        borderWidth: 1,
        borderColor: '#CCCCCC',
        borderRadius: 3,
        marginTop: 10,
        marginBottom: 15, // Margin after this whole combined box
    },
    // Container for T&C content within the receiverDetailsSection
    tncContentHolder: {
        paddingVertical: 6,
        paddingHorizontal: 6, // Horizontal padding for the T&C text block
        borderBottomWidth: 1, // Line after T&C, before Date field
        borderBottomColor: '#EEEEEE',
        borderTopWidth: 1,
        borderTopColor: "#CCCCCC"
        
    },
    termsAndConditionsPreamble: { // Formerly confirmationText
        fontSize: 7.5,
        marginBottom: 6, // Space before the numbered points
        lineHeight: 1.3,
        color: '#666666',
        textAlign: 'justify',
    },
    termsAndConditionsPoint: { // Formerly confirmationPoint
        flexDirection: 'row',
        marginBottom: 4, // Space between points
    },
    termsAndConditionsNumber: { // Formerly confirmationNumber
        width: '4%',
        fontSize: 7.5,
        fontWeight: 'bold',
        color: '#555555',
    ...
    termsAndConditionsPointText: { // Formerly confirmationPointText
        width: '96%',
        fontSize: 7.5,
        color: '#666666',
        lineHeight: 1.3,
    ...
    return (
        <Document title={`Goods Received - ${data.orderNumber}`}>
            <Page size="A4" style={styles.page}>
                ...
                {/* Combined Receiver Details, Confirmation & Signature Section */}
                <View style={styles.receiverDetailsSection} wrap={false}>
                    <Text style={styles.infoBoxTitle}>Receiver Details, Confirmation & Signature</Text>

                    {/* Receiver Detail Fields */}
                    <View style={styles.infoRow}>
                        <Text style={styles.infoLabel}>Receiver's Name</Text>
                        <Text style={styles.infoValue}>{imageStaticData.receiverName}</Text>
                    </View>
                    ...
                    <View style={styles.infoRow}> {/* Last standard info row before T&C */}
                        <Text style={styles.infoLabel}>EID Number</Text>
                        <Text style={styles.infoValue}>{imageStaticData.receiverEid}</Text>
                    </View>
                    ...
                    {/* Integrated Terms and Conditions Content */}
                    <View style={styles.tncContentHolder}>
                        <Text style={styles.termsAndConditionsPreamble}>
                            I, the undersigned, confirm that I have thoroughly inspected and verified the goods listed above upon receipt. I acknowledge that:
                        </Text>
                        <View style={styles.termsAndConditionsPoint}>
                            <Text style={styles.termsAndConditionsNumber}>1.</Text>
                        ...
                        <View style={[ styles.termsAndConditionsPoint, { marginBottom: 0 } ]}> {/* Last point, remove its bottom margin as tncContentHolder provides padding */}
                            <Text style={styles.termsAndConditionsNumber}>3.</Text>
                            <Text style={styles.termsAndConditionsPointText}>
                                {companyName} disclaims any further responsibility for the goods once they have been handed over to the customer or the customer's agent. Any loss, damage, or deterioration occurring after this point is solely the responsibility of the customer.
                            </Text>
