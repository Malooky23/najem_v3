...
export default function CreateItemForm() {
  ...
  const handleTouchEnd = (e: React.TouchEvent) => {
    // If it was scrolling, prevent focus
    ...
    return (
      <Drawer open={open} onOpenChange={setOpen}>
        <DrawerTrigger asChild>
          <Button variant="default" className="bg-green-300 hover:bg-primary/90">
        ...
        <DrawerContent className="h-[90vh]">
          ...
          <div className="flex-1 overflow-hidden form-scroll-container" id="form-container">
            <div 
              ...
              onTouchEnd={() => {
                // Add slight delay before allowing interaction again
                setTimeout(() => {
                  const container = document.getElementById('form-container');
                  if (container) {
          ...
          <style jsx global>{`
            ...
            .mobile-form-container button:not([type="submit"]) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="default" className="bg-green-500 hover:bg-primary/90">
          <Package className="mr-2 h-4 w-4" />
           New Item 1
        </Button>
      </DialogTrigger>
