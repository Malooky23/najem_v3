...
// import { useState, type ReactNode, Children, useEffect } from "react"
...
//   useEffect(() => {
//     if ( store.selectedCustomerData) {
//       setCustomerType(store.selectedCustomerData.customerType)
//       setIsFormSelected(true)
//     }
//     // Reset isFormSelected if the modal is closed or opened without pre-selected data
//     // You might adjust this logic based on whether you *want* to reset the form selection on close
//     // if (!isOpen) setIsFormSelected(false); // Optional: Reset form selection on close

//   }, [ , store.selectedCustomerData ]) // Dependencies: run when isOpen or selectedCustomerData changes
...
//             <span>{store.selectedCustomerData? "Edit": "New Customer"}</span>
//           </Button>
//         </DialogTrigger>
...
//               {!isFormSelected ? "Choose customer type to continue" : "Fill in the details below"}
//             </DialogDescription>
//           </DialogHeader>
...
//                 <CustomerForm initialData={store.selectedCustomerData} type={store.selectedCustomerData?.customerType ?? customerType!} onClose={() => setIsOpen(false)} />
//             </div>
//           )}
//         </DialogContent>
//       </Dialog>
